export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxee3ad0a91b3b52d6",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9c5a4b93da23818c67d22d506525c416",
  ...
  USERS: [
    {
      ...
      id: "oWUxs5o9MGKzCjP4y60DOqIGAmFQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "QTQoCeO3hv04xLq3mZ3Zc6HMtxakMmXLTWBurcBvXrs",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "濮阳",
